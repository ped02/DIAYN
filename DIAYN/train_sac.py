...
def main(environment_name: str, render: bool, seed: Optional[int] = None):
    ...
    for episode in range(episodes):
        ...
        mean_step_reward = rollout(envs, num_steps=n_steps, replay_buffer=replay_buffer, agent=sac_agent, device=device, reward_scale=0.01)
    ...
    # Visualize
    visualize(
        environment_name, 512, sac_agent, device
    )
