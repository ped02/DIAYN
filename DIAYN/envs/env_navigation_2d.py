...
class EnvNavigation2D(gym.Env):
    ...
    def __init__(self, render_mode: str = None):
        ...
        self.observation_space = spaces.Box(low=-3.0, high=3.0, shape=(2, ), dtype=np.float32)
    ...
    def step(self, action):
        ...
        action = np.clip(action, self.action_space.low, self.action_space.high).squeeze()
        ...
        return self.state, reward, terminated, truncated, {}  # Gymnasium step return format
